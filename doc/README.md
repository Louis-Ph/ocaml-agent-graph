...
This folder contains operator guides for using `ocaml-agent-graph`.
...
Swarm layer API reference:

- [../docs/swarm-layers.md](../docs/swarm-layers.md) — L0-L3 typed agentic swarm layer API reference with usage examples, layer map, and test-run commands
