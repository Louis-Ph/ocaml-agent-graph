...
This folder contains simple English guides for using `ocaml-agent-graph`.

Start here:

- [START_HERE.md](START_HERE.md): the easiest guide, written for beginners
- [HUMAN_TERMINAL_ASSISTANT.md](HUMAN_TERMINAL_ASSISTANT.md): operator guide for the assisted human terminal
